...
const MealPlanner = () => {
    ...
    const loadMealPlan = async () => {
        try {
            ...
            const response = await api.get(`/meal-plan/weekly?start_date=${startDate}`);
            const plans = response?.data?.data?.mealPlans || [];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {loading ? (
                    <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
                        <p className="text-gray-500">Loading meal planner...</p>
                    </div>
                ) : (
