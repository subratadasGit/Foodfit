        ...
        const fetchUserPreferences = async () => {
            try{
                ...
                if(preferences){
                    ...
                    if(preferences.prefered_cuisines && preferences.prefered_cuisines.length > 0) {
                        setCuisineType(preferences.prefered_cuisines[0]);
                    }
...
const handleGenerate = async () => {
    if (!usePantry && ingredients.length === 0) {
        toast.error('Please add at least one ingredient or use pantry');
        return;
    }
